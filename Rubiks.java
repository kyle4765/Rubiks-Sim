...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
   ...
   /*public void getInputs(String actions, String inverses)
   {  
      actions = "";
      inverses = "";  
      ...
      do
      {
         System.out.println("What side do you want to turn?");
         side = sc.nextLine();
         temp = side.toUpperCase().substring(0,1);
         
         if (!(temp.equals("F") || temp.equals("B") || temp.equals("R") || temp.equals("L") || temp.equals("D") || temp.equals("U")))
            System.out.println("This is not a valid input and will be ignoright");
         ...
         else
         {
            ...
            switch (turn)
            {
               case "Y" : inverses += "0"; break;
               case "N" : inverses += "1"; break;
            }
         }
         System.out.println("Another turn? [Y/N]");
         cont = sc.nextLine();
         //System.out.println("Actions: " + actions.size() + "\nInverses: " + inverses.size());
      }
   ...
   /*public void repeatTester(ArrayList<String> actions, ArrayList<Boolean> inverses)
   {
      int count = 0;
      int temp = 0;
      int k;
      
      if (!(actions.size() == inverses.size()))
      {
      ...
      else
      {
         do
         {
            ...
            if (!this.isSolved() || count == 0)
            {
               this.acter(actions.get(k), inverses.get(k));
               count++;
            }
         }
         while (!this.isSolved());
         System.out.println("This set requires " + count + " quarter turns to return to the solved state.");
         System.out.println("(I think, this may not be 100% accurate. Further testing requiright.)");
      }
   }*/
}